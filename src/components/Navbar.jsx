    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-[110] flex justify-center pointer-events-none">
        <motion.nav
          ...
          className={`pointer-events-auto mt-4 md:mt-6 transition-all duration-700 ease-[0.16, 1, 0.3, 1] ${scrolled
            ...
            <div className={`hidden md:flex items-center gap-1 transition-all duration-500 ${scrolled ? "mx-auto" : ""}`}>
              {navLinks.map((link) => (
                <a
                  ...
                  className={`relative px-4 py-2 text-[10px] font-mono uppercase tracking-[0.2em] transition-all duration-500 group ${activeTab === link.path ? "text-white font-black" : "text-white/30 hover:text-white/60"
                    }`}
                >
              ...
              <div className="flex flex-col items-center gap-6 w-full">
                {navLinks.map((link, i) => (
                  <motion.a
                    ...
                    href={link.path}
                    onClick={(e) => handleNavClick(e, link.path)}
                    className={`text-4xl font-heading font-black uppercase tracking-tighter transition-all duration-500 ${activeTab === link.path ? "text-[#d4a843] scale-110" : "text-white/10 hover:text-white/30"
                      }`}
                  >
                    {link.name}
                  </motion.a>
